...
<xsl:variable name="includeCollectionGroup">1</xsl:variable>
<xsl:variable name="portletType">Collection</xsl:variable>
<xsl:variable name="prototypeURI">/sas/portlets/Collection/display</xsl:variable>
