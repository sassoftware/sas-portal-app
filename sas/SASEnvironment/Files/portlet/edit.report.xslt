...
<xsl:variable name="portletURI" select="$configPropertySet/SetProperties/Property[@Name='SELECTED_REPORT']/@DefaultValue"/>
<xsl:variable name="portletPath" select="substring-after($portletURI,'SBIP://METASERVER')"/>

<xsl:variable name="portletURIFolder" select="$configPropertySet/SetProperties/Property[@Name='SELECTED_FOLDER']/@DefaultValue"/>
