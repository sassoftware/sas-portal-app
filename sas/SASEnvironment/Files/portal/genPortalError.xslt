...
<html>
  <head>
    ...
    <script src="sasjs.js"></script>
    <script src="custom-sasjs-scripts.js?v=100"></script>

    <!-- SAS Connection information setup information -->

    <script src="setup.js?v=5"></script>

    <!-- style extensions specific to this app -->

    <link rel="stylesheet" href="thisStyle.css?v=3"/>
